...
export async function POST(req) {
  ...
  if (!title || !description || !categoryId || !venueId || isNaN(startAt) || isNaN(endAt)) {
  ...
  const event = await prisma.event.create({
    data: { title, description, startAt, endAt, categoryId, venueId, organizerId: auth.id, posterUrl },
  });
